...
function check_errors_in_form() {
    ...
    $("#errorbox span").html(" <img src='http://www.aimkon.com/static/dinette/images/ajaximage.gif' alt='ajax image'/> &nbsp; posting...........  ")
...
function check_errors_in_Replyform() {
    ...
    $("#errorbox span").html(" <img src='http://www.aimkon.com/static/dinette/images/ajaximage.gif' alt='ajax image'/> &nbsp; posting the reply...........  ");
