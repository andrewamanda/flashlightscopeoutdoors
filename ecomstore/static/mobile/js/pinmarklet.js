(function (m, o, n) {
            ...
            return {
                ...
                make: function (b) {
                    ...
                    for (d in b) if (b[d].hasOwnProperty) {
                            ...
                            for (g in b[d]) b[d][g].hasOwnProperty && typeof b[d][g] === "string" &&
                                    a.f.set(c, g, b[d][g]);
                            break
                        }
                    return c
                ...
                log: function (b, c) {
                    b = "?page=" + encodeURIComponent(a.d.URL) + "&reason=" + encodeURIComponent(b);
                    if (c) b = b + "&image=" + encodeURIComponent(c);
                    a.f.call(a.a.log + b, a.f.ping.log)
                },
                pin: function (b) {
                    var c = a.a.pin + "/" + a.a.pinMethod + "/?",
                        d = "false",
                        g = a.f.get(b, "pinImg"),
                        e = a.f.get(b, "pinUrl") || a.d.URL,
                        f = a.v.selectedText || a.f.get(b, "pinDesc") || a.d.title;
                    if (b.rel === "video") d = "true";
                    c = c + "media=" + encodeURIComponent(g);
                    c = c + "&url=" + encodeURIComponent(e);
                    ...
                    if (a.v.hazIOS) a.w.location =
                            "http://" + c;
                    else a.w.open("http://" + c, "pin" + (new Date).getTime(), a.a.pop)
                },
                close: function (b) {
                    if (a.s.bg) {
                        a.s.shim && a.d.b.removeChild(a.s.shim);
                        a.s.bd && a.d.b.removeChild(a.s.bd);
                        a.d.b.removeChild(a.s.bg)
                    }
                    m.hazPinningNow = false;
                    b && a.w.alert(b);
                ...
                click: function (b) {
                    ...
                    if (c = b.target ? b.target.nodeType === 3 ? b.target.parentNode : b.target : b.srcElement) if (c === a.s.x) a.f.close();
                        else if (c.className !== a.a.k + "_hideMe") if (c.className === a.a.k +
                            "_pinThis") {
                            a.f.pin(c);
                ...
                thumb: function (b) {
                    if (b.src) {
                        ...
                        a.f.set(f, "pinterestCreated", "pinterestCreated");
                        b.page && a.f.set(g, "pinUrl", b.page);
                        if (a.v.canonicalTitle || b.title) a.f.set(g, "pinDesc", a.v.canonicalTitle || b.title);
                        b.desc && a.f.set(g, "pinDesc", b.desc);
                        b.description && a.f.set(g, "pinDesc", b.description);
                        ...
                        if (b.dupe) {
                            e = 0;
                            for (f = a.v.thumbed.length; e < f; e += 1) if (a.v.thumbed[e].id.indexOf(b.dupe) !== -1) {
                                    g = a.v.thumbed[e].id;
                                    break
                                }
                        }
                        if (g !== false) if (g = a.d.getElementById(g)) {
                ...
                call: function (b, c) {
                    ...
                    e.charset = "utf-8";
                    a.v.firstScript ? a.v.firstScript.parentNode.insertBefore(e, a.v.firstScript) : a.d.b.appendChild(e);
                    a.v.awaitingCallbacks += 1
                },
                ping: {
                    log: function () {},
                    checkDomain: function (b) {
                        ...
                        if (b && b.disallowed_domains && b.disallowed_domains.length) {
                            ...
                            c = 0;
                            for (d = a.v.thumbed.length; c < d; c += 1) if (a.v.badDomain[a.f.get(a.v.thumbed[c], "domain")] === true) {
                                    b = a.v.thumbed[c].id.split("thumb_")[1];
                                    a.f.log("image_from_blacklisted_domain", b);
                                    a.f.unThumb(a.v.thumbed[c].id.split("thumb_").pop())
                                }
                        }
                    },
                    info: function (b) {
                        if (b) if (b.err) {
                                a.f.log("api_nopin");
                                b.data && b.data.id && a.f.unThumb(b.data.id)
                            } else if (b.data && b.data.reply) if (b.data.reply.nopin && b.data.reply.nopin === 1) {
                                a.f.log("api_nopin",
                                    b.data.reply.img.src);
                                a.f.unThumb(b.data.id)
                            } else if (b.data.reply.img && b.data.reply.img.src) {
                            ...
                            a.f.thumb({
                                provider: b.data.src,
                                src: b.data.reply.img.src,
                                height: b.data.reply.img.height,
                                width: b.data.reply.img.width,
                                media: b.data.reply.media,
                                desc: b.data.reply.description,
                                page: b.data.reply.page || "",
                                duration: b.data.reply.duration || 0,
                                total_slides: b.data.reply.total_slides || 0,
                                dupe: b.data.id
                            })
                        }
                    }
                ...
                getExtendedInfo: function (b) {
                    if (b.src && b.id) {
                        var c = b.src + ":" + b.id;
                        if (!a.v.hazCalledForInfo[c]) {
                            a.v.hazCalledForInfo[c] = true;
                            a.f.call(a.a.embed + b.src + "/?id=" + b.id, a.f.ping.info)
                        }
                    }
                },
                getId: function (b) {
                    for (var c, d = b.u.split("?")[0].split("#")[0].split("/"); !c;) c =
                            d.pop();
                ...
                seekCanonical: function (b) {
                    ...
                    e = a.v[d.tagName] || a.d.getElementsByTagName(d.tagName);
                    k = e.length;
                    for (i = 0; i < k; i += 1) {
                        f = a.f.get(e[i], d.property);
                        if ((h = a.f.get(e[i], d.content)) && f) if (d.field[f]) j[d.field[f]] = h
                    }
                    ...
                    if (j.pUrl &&
                        ...
                        g.title = a.v.canonicalTitle;
                        g.setAttribute("page", j.pUrl);
                        ...
                        a.v.canonicalImage = g.src = j.pImg;
                        return g
                    }
                    return null
                },
                hazUrl: {
                    artsy: function () {
                        var b = a.f.seekCanonical("artsy");
                        if (b) {
                            b.setAttribute("extended", true);
                            b.setAttribute("dupe", b.src);
                            a.f.getExtendedInfo({
                                src: "artsy",
                                id: encodeURIComponent(b.src)
                            })
                        }
                    },
                    dailymotion: function () {
                        var b = a.f.seekCanonical("dailymotion");
                        if (b) {
                            b.setAttribute("extended",
                                true);
                            b.setAttribute("dupe", b.src);
                            a.f.getExtendedInfo({
                                src: "dailymotion",
                                id: encodeURIComponent(a.d.URL.split("?")[0].split("#")[0])
                            })
                        }
                    },
                    etsy: function () {
                    ...
                    youtube: function () {
                        ...
                        if (b) {
                            ...
                            a.f.getExtendedInfo({
                                src: "youtube",
                                id: encodeURIComponent(b.getAttribute("page").split("=")[1].split("&")[0])
                            })
                        }
                    },
                    vimeo: function () {
                ...
                hazSite: {
                    ...
                    imdb: {
                        img: function (b) {
                            if (b.src) {
                                var c = b.src.toString();
                                if (c.match(/@@(.*)/)) {
                                    var d = c.replace(/@@(.*)/, "@@._V1_SX800.jpg"),
                                        g = new Image;
                                    g.onload = function () {
                                        if (this.height > a.a.floorImgSize && this.width > a.a.floorImgSize && (this.height > a.a.minImgSize || this.width > a.a.minImgSize)) a.f.thumb({
                                                dupe: c,
                                                media: "image",
                                                src: this.src,
                                                title: b.title,
                    ...
                    netflix: {
                        img: function (b) {
                            if (b = b.src.split("?")[0].split("#")[0].split("/").pop()) {
                                ...
                                b > 1E3 && a.v.inlineHandler && a.v.inlineHandler === "netflix" && a.f.getExtendedInfo({
                                    src: "netflix",
                                    id: b
                                })
                            }
                    ...
                    youtube: {
                        ...
                        video: function (b) {
                            (b =
                                a.f.get(b, "data-youtube-id")) && a.f.getExtendedInfo({
                                src: "youtube",
                                id: b
                            })
                        },
                ...
                handleInline: {
                    google: function (b) {
                        if (b) {
                            ...
                            if (e) {
                                g = b.parentNode;
                                if (g.tagName === "A" && g.href) {
                                    b = decodeURIComponent(a.f.parse(g.href, "&imgrefurl="));
                                    c = a.f.parse(g.href, "&imgurl=");
                                    d = parseInt(a.f.parse(g.href, "&w="), 10);
                                    g = parseInt(a.f.parse(g.href, "&h="), 10);
                                    if (c && e && b && g > a.a.floorImgSize && d > a.a.floorImgSize && (g > a.a.minImgSize || d > a.a.minImgSize)) a.f.thumb({
                                            thumb: e,
                                            src: c,
                                            page: b,
                                            height: g,
                    ...
                    tumblr: function (b) {
                        var c = a.d.URL,
                            d = a.f.get(b, "title") || a.f.get(b, "alt"),
                            g = a.f.get(b, "src"),
                            e = b.parentNode,
                            f = null,
                            h = null,
                            ...
                            k = null,
                            j, l;
                        if (a.d.URL.match(/tumblr\.com/)) {
                            if (g.match(/assets\.tumblr\.com/) || b.height < a.a.minImgSize || b.width < a.a.minImgSize) return;
                            if (a.d.URL.match(/tumblr\.com\/dashboard/)) {
                                if (e) {
                                    if (e.tagName === "A") {
                                        if (e.href) {
                                            j = e.href.split("#")[0].split("?")[0];
                                            if (j.match(/(gif|png|jpg|jpeg)$/)) i = e.href;
                                            if (e.id) {
                                                e = e.id.split("_");
                                                for (j = 0; j < e.length; j += 1) {
                                                    f = e.pop();
                                                    if (parseInt(f,
                                                        10) > 1E3) if ((l = a.d.getElementById("permalink_" + f)) && l.href) {
                                                            h = l.href;
                                                            break
                                                        }
                                                }
                                    ...
                                    } else if (e.parentNode && e.parentNode.id && e.parentNode.id.match(/^post_content/)) {
                                        f = e.parentNode.id.split("_").pop();
                                        if ((l = a.d.getElementById("permalink_" + f)) && l.href) h = l.href
                                    }
                                    if (f = a.d.getElementById("post_content_" + f)) {
                                        e = f.getElementsByTagName("DIV");
                                        for (f = 0; f < e.length; f += 1) if (e[f].className === "caption") {
                                                k = e[f].innerHTML.replace(/<[^>]*>/g, "").replace(/^\s+|\s+$/g, "").replace(/\n/g, " ").replace(/ +/g, " ");
                                                break
                                            }
                                    }
                                    if (!k &&
                                        h) k = "Found on " + h.split("/")[2] + " via Tumblr"
                                }
                            } else if (!a.d.URL.match(/\/post\//)) if (e && e.tagName === "A" && e.href) {
                                    j = e.href.split("#")[0].split("?")[0];
                                    if (j.match(/(gif|png|jpg|jpeg)$/)) i = e.href;
                                    else h = e.href
                                }
                ...
                hazTag: {
                    img: function (b) {
                        if (a.v.inlineHandler && typeof a.f.handleInline[a.v.inlineHandler] === "function") a.f.handleInline[a.v.inlineHandler](b);
                            ...
                            if (b.height > a.a.floorImgSize &&
                                b.width > a.a.floorImgSize && (b.height > a.a.minImgSize || b.width > a.a.minImgSize)) {
                                ...
                                a.f.thumb({
                                    ...
                                    width: b.width,
                                    title: b.title || b.alt,
                                    description: a.f.get(b, "data-pin-description")
                                })
                            }
                ...
                checkTags: function () {
                    var b, c, d, g, e, f, h, i, k;
                    b = 0;
                    for (c = a.a.check.length; b < c; b += 1) {
                        e = a.d.getElementsByTagName(a.a.check[b]);
                        d = 0;
                        for (g = e.length; d < g; d += 1) {
                            f = e[d];
                            a.f.get(f, "nopin") && !a.f.get(f, "pinterestCreated") && a.f.log("image_with_inline_nopin", f.src);
                            !a.f.get(f, "nopin") && f.style.display !== "none" && f.style.visibility !== "hidden" && a.v.tag.push(f)
                        }
                    }
                    b = 0;
                    for (c = a.v.tag.length; b <
                        c; b += 1) {
                        e = a.v.tag[b];
                        f = e.tagName.toLowerCase();
                        if (a.a.tag[f]) for (h in a.a.tag[f]) if (a.a.tag[f][h].hasOwnProperty) {
                                    i = a.a.tag[f][h];
                                    if ((k = a.f.get(e, i.att)) && !k.match(/^data/)) {
                                        d = 0;
                                        for (g = i.seek.length; d < g; d += 1) k.match(i.seek[d]) && a.f.hazSite[h][f](e)
                                    }
                                }
                        a.f.hazTag[f] && a.f.hazTag[f](e)
                    }
                ...
                structure: function () {
                    ...
                    a.f.set(a.s.shim, "pinterestCreated", "pinterestCreated");
                ...
                readArgs: function (b) {
                    if (b.getAttribute("noCancel")) a.a.noCancel = true;
                    if (b.getAttribute("noHeader")) a.a.noHeader = true;
                    if (b.getAttribute("pinMethod")) a.a.pinMethod = b.getAttribute("pinMethod");
                    a.w.setTimeout(function () {
                ...
                init: function () {
                    ...
                    if (a.d.b) {
                        if (m.hazPinningNow !== true) {
                            m.hazPinningNow = true;
                            var b = a.w.navigator.userAgent;
                            a.v = {
                                ...
                                if (a.f.checkPage()) if (a.v.hazGoodUrl === true) {
                                        ...
                                        if (a.f.callback.length > 1) {
                                            ...
                                            a.v.waitForCallbacks = a.w.setInterval(function () {
                                                if (!a.v.awaitingCallbacks) if (a.v.hazAtLeastOneGoodThumb ===
                                                        0 || a.v.tag.length === 0) {
                                                        a.f.close(a.a.msg.notFound);
                                                        return
                                                    }
                                                if (a.v.waitCount > 9 || !a.v.awaitingCallbacks) a.w.clearInterval(a.v.waitForCallbacks);
                                                a.v.waitCount++
                                            }, 500)
    ...
    tag: {
        img: {
            ...
            netflix: {
                att: "src",
                seek: [/^http:\/\/cdn-?[0-9]\.nflximg\.com/,
                        /^http?s:\/\/netflix\.hs\.llnwd\.net/
                ]
            },
            polyvore: {
                att: "src",
            ...
            shutterstock: {
                att: "src",
                seek: [/^https?:\/\/image.shutterstock\.com/]
            },
            ted: {
                att: "src",
                seek: [/^https?:\/\/(.*?)\.ted\.com/]
            ...
            youtube: {
                att: "src",
                seek: [/ytimg.com\/vi/, /img.youtube.com\/vi/]
            }
        },
        video: {
            youtube: {
        ...
        embed: {
            youtube: {
                att: "src",
                seek: [/^http:\/\/s\.ytimg\.com\/yt/, /^http:\/\/.*?\.?youtube-nocookie\.com\/v/]
            }
        },
        iframe: {
            ted: {
            ...
            youtube: {
                att: "src",
                seek: [/^http:\/\/www\.youtube\.com\/embed\/([a-zA-Z0-9\-_]+)/]
            }
        },
        object: {
            youtube: {
                att: "data",
                seek: [/^http:\/\/.*?\.?youtube-nocookie\.com\/v/]
            },
            dailymotion: {
                att: "data",
                seek: [/^http:\/\/.*?\.dailymotion.com\/video/]
            }
        }
    },
    msg: {
    ...
    rules: ["#_shim {z-index:2147483640; position: absolute; background: transparent; top:0; right:0; bottom:0; left:0; width: 100%; border: 0;}", "#_bg {z-index:2147483641; position: absolute; top:0; right:0; bottom:0; left:0; background-color:#f2f2f2; opacity:.95; width: 100%; }", "#_bd {z-index:2147483642; position: absolute; text-align: center; width: 100%; top: 0; left: 0; right: 0; font:16px hevetica neue,arial,san-serif; }",
            "#_bd #_hd { z-index:2147483643; -moz-box-shadow: 0 1px 2px #aaa; -webkit-box-shadow: 0 1px 2px #aaa; box-shadow: 0 1px 2px #aaa; position: fixed; *position:absolute; width:100%; top: 0; left: 0; right: 0; height: 45px; line-height: 45px; font-size: 14px; font-weight: bold; display: block; margin: 0; background: #fbf7f7; border-bottom: 1px solid #aaa; }", "#_bd #_hd.noHeader { height: 1px; background-color:#f2f2f2; -moz-box-shadow: none; -webkit-box-shadow: none; box-shadow: none; border: none; }",
            "#_bd #_hd a#_x { display: inline-block; cursor: pointer; color: #524D4D; line-height: 45px; text-shadow: 0 1px #fff; float: right; text-align: center; width: 100px; border-left: 1px solid #aaa; }", "#_bd #_hd a#_x:hover { color: #524D4D; background: #e1dfdf; text-decoration: none; }", "#_bd #_hd a#_x:active { color: #fff; background: #cb2027; text-decoration: none; text-shadow:none;}", "#_bd #_hd #_logo {height: 43px; width: 100px; display: inline-block; margin-right: -100px; background: transparent url(_cdn/images/LogoRed.png) 50% 50% no-repeat; border: none;}",
            "@media only screen and (-webkit-min-device-pixel-ratio: 2) { #_bd #_hd #_logo {background-size: 100px 26px; background-image: url(_cdn/images/LogoRed.2x.png); } }", "#_bd #_spacer { display: block; height: 50px; }", "#_bd span._pinContainer { height:200px; width:200px; display:inline-block; background:#fff; position:relative; -moz-box-shadow:0 0  2px #555; -webkit-box-shadow: 0 0  2px #555; box-shadow: 0 0  2px #555; margin: 10px; }", "#_bd span._pinContainer { zoom:1; *border: 1px solid #aaa; }", "#_bd span._pinContainer img { margin:0; padding:0; border:none; }",
            "#_bd span._pinContainer span._img, #_bd span._pinContainer span._play { position: absolute; top: 0; left: 0; height:200px; width:200px; overflow:hidden; }", "#_bd span._pinContainer span._play { background: transparent url(_cdn/images/bm/play.png) 50% 50% no-repeat; }", "#_bd span._pinContainer cite, #_bd span._pinContainer cite span { position: absolute; bottom: 0; left: 0; right: 0; width: 200px; color: #000; height: 22px; line-height: 24px; font-size: 10px; font-style: normal; text-align: center; overflow: hidden; }",
            "#_bd span._pinContainer cite span._mask { background:#eee; opacity:.75; *filter:alpha(opacity=75); }", "#_bd span._pinContainer cite span._artsy { background: transparent url(_cdn/images/attrib/artsy.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._behance { background: transparent url(_cdn/images/attrib/behance.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._dasauge { background: transparent url(_cdn/images/attrib/dasauge.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._dreamstime { background: transparent url(_cdn/images/attrib/dreamstime.png) 180px 3px no-repeat; }",
            "#_bd span._pinContainer cite span._flickr { background: transparent url(_cdn/images/attrib/flickr.png) 182px 3px no-repeat; }", "#_bd span._pinContainer cite span._fivehundredpx { background: transparent url(_cdn/images/attrib/fivehundredpx.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._kickstarter { background: transparent url(_cdn/images/attrib/kickstarter.png) 182px 3px no-repeat; }", "#_bd span._pinContainer cite span._polyvore { background: transparent url(_cdn/images/attrib/polyvore.png) 182px 3px no-repeat; }",
            "#_bd span._pinContainer cite span._slideshare { background: transparent url(_cdn/images/attrib/slideshare.png) 182px 3px no-repeat; }", "#_bd span._pinContainer cite span._soundcloud { background: transparent url(_cdn/images/attrib/soundcloud.png) 182px 3px no-repeat; }", "#_bd span._pinContainer cite span._ted { background: transparent url(_cdn/images/attrib/ted.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._vimeo { background: transparent url(_cdn/images/attrib/vimeo.png) 180px 3px no-repeat; }",
            "#_bd span._pinContainer cite span._vimeo_s { background: transparent url(_cdn/images/attrib/vimeo.png) 180px 3px no-repeat; }", "#_bd span._pinContainer cite span._youtube { background: transparent url(_cdn/images/attrib/youtube.png) 180px 3px no-repeat; }", "#_bd span._pinContainer a { text-decoration:none; background:transparent url(_cdn/images/bm/button.png) 60px 300px no-repeat; cursor:pointer; position:absolute; top:0; left:0; height:200px; width:200px; }", "#_bd span._pinContainer a { -moz-transition-property: background-color; -moz-transition-duration: .25s; -webkit-transition-property: background-color; -webkit-transition-duration: .25s; transition-property: background-color; transition-duration: .25s; }",
