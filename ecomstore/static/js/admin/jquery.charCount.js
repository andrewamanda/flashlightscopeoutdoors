 ...
 * http://gpowered.net
 */
 	//for whatever reason, this anoymous function results in charCount not defined error
(function($) {
  ...
  console.log("counter ready");
	...
	//for whatever reason, this anoymous function results in charCount not defined error
		...
		$(this).each(function() {
			...
			$(this).keyup(function(){calculate(this, options); });
			$(this).change(function(){calculate(this, options)});
		});
